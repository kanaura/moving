...
<body class="home">
    ...
    <div class="wrap">
        ...
        <div class="content">
            ...
            <a class="btn-default" href="./form.php">通常お見積もりのお客様</a>

            <a class="btn-default" href="./form.php">三福綜合不動産ご契約のお客様</a>
            ...
            <div class="lead">
                ...
                <p class="txt txt-has-star">
                    ...
                    非対面カンタンお見積りシステムで表示された金額は概算となりますので実際の金額とは異なる場合があります。あらかじめご了承ください。
